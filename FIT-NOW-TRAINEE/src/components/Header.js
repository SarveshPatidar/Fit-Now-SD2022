...
import {toggleTheme, toggleSI, signOut, toggleReg} from '../global/Reducer';
    ...
    <div className={classes.root}>
      <AppBar position="static">
        <Toolbar>
          ...
          (
            <><Button onClick={() => { app.dispatch(toggleReg()); } } color="inherit" variant="outlined">
                Sign Up
              </Button> &nbsp;<Button onClick={() => app.dispatch(toggleSI())} color="inherit" variant="outlined">
                  Login
                </Button></>
          )
          }
